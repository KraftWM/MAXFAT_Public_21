...
% -----------------------------------------------------------------
% Funktion bestimmt Weff Woehlerlinie aus DWL(glatte Probe R=-1)
% fuer Pz
% INPUT:
% E             - E Modul
% ef,sf,b,c     - DWL
% OUTPUT:
% Weff_stuetz   - Stuetzstelle bei N = 1
% d             - Neigung
% -----------------------------------------------------------------
% ... Ramberg Osgood Parameter aus Konsistenzbedingung
ns = bf/cf;
Ks = sf/ef^ns;
...
% ... Speicher
ndp = 100;
N = zeros(1,ndp);   % Speicher Lebensdauer Woehlerlinie
...
end % Ende Bestimmen Weff Woehlerlinie


% ... bestimme schließspannung fuer einfaches ramberg osgood
function scl = closesig(s,e,ecl,E,Ks,ns)
% -----------------------------------------------------------------
% Berechnung Rissschließdehnung aus RO Parameter
% !!! mit verdopplungsgesetz auf halbaesten
% INPUT:
%      s       - Spannung
%      e       - Dehnung
%      ecl     - Schließdehnung
