...
%   Y1A0            - Geometriefunktion Mode I Punkt A
%   Y2A0            - Geometriefunktion Mode II Punkt A
%   Y3A0            - Geometriefunktion Mode III Punkt A
...
% PUBLIC:
   properties % Notwendige Größen für Kerbnäherung
       ...
       FA {mustBeNumeric} = 15;                                            % Abklingkonstante Rissöffnung  
...
% ------------------------------------------------------------------------- 
methods
    function obj = PZ(E,nu,Rm,Kstrich,nstrich,sf,ef,bf,cf,ND,varargin)
        %------------------------------------------------------------------
...
methods (Static)    
    ...
    % ... Geometriefaktoren
    function [YIIA,YIIB,YIIIA,YIIIB] = Y_OFR_TYPA_SH(azc,azr)
        ...
        % ... Modus II
        YIIA = 0;
        YIIB = akima2d(6,5,ar,ac,f2b,lr,azr,azc);
%         YIIB = akima2D_mex(6,5,ar,ac,f2b,lr,azr,azc);
        % ... Modus III
        YIIIA = akima2d(6,5,ar,ac,f3a,lr,azr,azc);
%         YIIIA = akima2D_mex(6,5,ar,ac,f3a,lr,azr,azc);
...
%         YIA = akima2D_mex(6,5,ar,ac,f1a,lr,azr,azc);
        YIB = akima2d(6,5,ar,ac,f1b,lr,azr,azc);
%         YIB = akima2D_mex(6,5,ar,ac,f1b,lr,azr,azc);
        
    end % Ende Funktion
    function [YIA,YIB,YIIA,YIIB,YIIIA,YIIIB] = Y_OFR_TYPB_ZD(azc,azr)
        % Funktion gibt risslängenabhängige Geometriefunktionen in abhängigkeit des
        % Risslängenverhältnisses a/c und Geometrieverhältniss a/rho
        %
        ...
        YIIA = akima2d(6,5,ar,ac,f2a,lr,azr,azc);
%         YIIA = akima2D_mex(6,5,ar,ac,f2a,lr,azr,azc);
        YIIIA = 0;
        ...
        YIIIB = akima2d(6,5,ar,ac,f3b,lr,azr,azc);
%         YIIIB = akima2D_mex(6,5,ar,ac,f3b,lr,azr,azc);
    ...
    function [sxop] = newman_max(sxo,sxu,sw,sv,sf,M_sig,ators)
        ...
        if sxo > 0
            ...
            if R > 0
                ...
                Re = R * sv/sw; % ( 0 <= svo/swo <= 2 ); ( -oo < Rw <= 0 )
            end
